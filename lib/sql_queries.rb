...
"SELECT title,SUM(amount) from projects,pledges where projects.id = pledges.project_id group by projects.title;"
end

def selects_the_user_name_age_and_pledge_amount_for_all_pledges_alphabetized_by_name
"select name,age,SUM(amount) from users,pledges where users.id = pledges.user_id group by users.name;"
end
